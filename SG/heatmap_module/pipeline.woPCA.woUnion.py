...
morphology = np.loadtxt(filename, delimiter="\t", skiprows=True, usecols=(7,9,12,13)).reshape((A.shape[0],4)) 
...
# print('...Generating the union graph...')
...
# print('There are '+str(len(graphs))+' subgraphs in the union graph')
