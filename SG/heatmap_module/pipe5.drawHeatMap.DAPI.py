...
plt.title(title)
plt.savefig("./HE_png/"+str(ID)+"_distro-"+str(feature)+"-"+str(scale)+"_scale"+"-nn"+str(steps)+".png") # save as png
plt.close()
###########################################
...
plt.axis('off')
plt.savefig("./HE_png/"+str(ID)+"_heatmap-"+str(feature)+"-"+str(scale)+"_scale""-"+str(modality)+"_partition-nn"+str(steps)+".png", dpi=200,bbox_inches = 'tight', pad_inches = 0.5) # save as png
plt.close()
