...
def cluster_nuclei_intensity(filename,df,n_neighbors,threshold_q,auto_open,plot_switch):
    ...
    min_cluster_size = int(df1.shape[0]/50)     # hyperparameter
    min_samples = int(min_cluster_size/50)       # hyperparameter
...
filename = sys.argv[1] #'../data_intensity/pkl/id_52.measurements.covd.pkl' # pkl file
...
for c_id in set(df.clusterID1): # for each cluster1 id
    ...
    min_samples = int(min_cluster_size/20)         # hyperparameter
